...
//
// A Worker cannot read its own package.json, so this is how @pithy-sh/organization knows its own version at
...
export const PACKAGE_NAME = "@pithy-sh/organization";
