...
- [#546](https://github.com/pithy-sh/pithy/pull/546) [`caab3fa`](https://github.com/pithy-sh/pithy/commit/caab3fab1c08b7f4b8f515c03d7d58e08e4f7bae) Thanks [@kingmesal](https://github.com/kingmesal)! - The Google rail verifies through `core/http/oidcWebhook`, and an anonymous flood buys one key fetch.
  
  There were two OIDC verifiers in the kit — `payments/src/rails/google/oidc.ts` and the core module [#518](https://github.com/pithy-sh/pithy/issues/518) generalized out of it — and they could drift. That is the shape of [#501](https://github.com/pithy-sh/pithy/issues/501), [#513](https://github.com/pithy-sh/pithy/issues/513) and [#519](https://github.com/pithy-sh/pithy/issues/519), and it matters more here, because the thing that can drift is an authentication boundary.
...
- [#531](https://github.com/pithy-sh/pithy/pull/531) [`a24ebff`](https://github.com/pithy-sh/pithy/commit/a24ebff4bbe18f5571344dd3f79113a809494fc5) Thanks [@kingmesal](https://github.com/kingmesal)! - An OIDC verifier, for a webhook whose sender is a CI job rather than a payment rail.
...
- [#531](https://github.com/pithy-sh/pithy/pull/531) [`a24ebff`](https://github.com/pithy-sh/pithy/commit/a24ebff4bbe18f5571344dd3f79113a809494fc5) Thanks [@kingmesal](https://github.com/kingmesal)! - The identity provider's half of an OIDC webhook ships as test utilities, so an adopter proves their route instead of rebuilding the kit's fixtures.
