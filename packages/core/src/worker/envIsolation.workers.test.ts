 ...
 * `worker-safety.test.ts` is the gate for the same rule at the import level. The `nodejs_compat` flag
 * this project's workers config sets is what puts a `process` in scope at runtime.
 */
