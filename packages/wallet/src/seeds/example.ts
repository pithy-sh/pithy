 ...
 * {@link WALLET_MIGRATION_ORDER} (a different registry, composed separately by `pithy seed`).
 */
const WALLET_EXAMPLE_SEED_ORDER = 200;
 ...
 */
export const walletExampleSeed: SeedSet = defineSeed({
  name: "example",
  order: WALLET_EXAMPLE_SEED_ORDER,
  environments: ["dev", "staging"],
  example: true,
  d1: [
    d1SeedGroup("app", WALLET_ACCOUNTS_TABLE, WalletAccount, [
      {
        id: 1,
