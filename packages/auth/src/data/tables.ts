 ...
 *
 * The first six tables are Better-Auth-managed; `pithyAuthDevices` is ours. Setting Better Auth's
 * `modelName` to these exact camelCase keys lets the one `CamelCasePlugin` own the camelCase ↔
 * snake_case boundary uniformly for both Better Auth's queries and our migration DDL.
 */
